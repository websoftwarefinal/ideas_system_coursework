...
VALUES 
('JD''John', 'Doe', 'john.doe@example.com', '1234567890', 'password123', 'active', 'Manager', 1, 1),
('JS''Jane', 'Smith', 'jane.smith@example.com', '9876543210', 'password456', 'active', 'Employee', 2, 2),
('MJ''Michael', 'Johnson', 'michael.johnson@example.com', '1231231234', 'password789', 'active', 'Employee', 2, 3);
